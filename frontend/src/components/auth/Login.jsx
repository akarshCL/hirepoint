...
const Login = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className='flex items-center justify-center px-3 mx-auto max-w-7xl'>
                <form onSubmit={submitHandler} className='w-1/2 p-4 my-10 border border-gray-200 rounded-md max-sm:w-full'>
